...
gpgpu.particlesVariable.material.uniforms.uFlowFieldFrequence = new THREE.Uniform(0.5)
...
gui.add(gpgpu.particlesVariable.material.uniforms.uFlowFieldFrequence, 'value').min(0).max(1).step(0.001).name('uFlowFieldFrequence')
